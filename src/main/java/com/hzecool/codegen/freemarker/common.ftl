...
<#assign _year>2017</#assign>
<#assign _company>hangzhou jingshu technology Co., LTD</#assign>
<#assign _time>${obj.date?date}</#assign>
<#assign _pkg>${obj.pkg}</#assign>
<#assign _cpkg>${_pkg}.model</#assign>
...
<#assign _cfullname>${_cpkg}.${_cname}</#assign>
<#assign _servicepkg>${_pkg}.service</#assign>
<#assign _viewpkg>${_pkg}.view</#assign>
<#assign _actionpkg>${_pkg}.action</#assign>
<#assign _viewqueryname>${_cname}QueryAction</#assign>
<#assign _viewactionname>${_cname}Action</#assign>
...
<#assign _serviceimplpkg>${_pkg}.service.impl</#assign>
...
<#assign _daopkg>${_pkg}.dao</#assign>
